...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002477124601')).split()]  # For Multiple Id Use One Space Between Each.
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Widesmovie')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://grateful-cate-ashinbha-25e79d47.koyeb.app/")
